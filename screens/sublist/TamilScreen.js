  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.homeworkContainer}>
        ...
        <Text style={styles.homeworkText}>{homeworks[selectedDate] || 'No homework assigned.'}</Text>
      </View>
      ...
      <TouchableOpacity style={styles.addButton} onPress={() => navigation.navigate('PostHomework')}>
        <Text style={styles.addButtonLabel}>Post Homework</Text>
      </TouchableOpacity>
    </SafeAreaView>
  );
}
